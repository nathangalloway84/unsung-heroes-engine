...
export default function VisibilityGapCard() {
  return (
        ...
        <div className="p-10 flex flex-col md:flex-row items-center gap-12 relative z-10">
          <div className="flex-1">
            ...
            <div className="max-w-2xl text-on-surface-variant font-body leading-relaxed text-base animate-fade-pulse border-l-2 border-outline-variant/30 pl-4">
              <p>The discrepancy between professional funding and elite performance metrics has reached a <span className="text-[#ffba20] font-bold">Terminal Inflection Point</span>. Athletes in the Wrestling sector are operating at 140% of standard output with only 22% of the media index visibility.</p>
            </div>
          </div>
        </div>
      </div>
